  ...
  return (
    <div className="max-w-[8.5in] mx-auto bg-white p-8 font-sans">
      ...
      <div className="mb-8 text-right">
        <div className="text-lg font-semibold text-gray-900">{senderInfo.fullName}</div>
        <div className="text-gray-600">{senderInfo.email}</div>
        <div className="text-gray-600">{senderInfo.phone}</div>
        <div className="text-gray-600 whitespace-pre-line">{senderInfo.address}</div>
        <div className="text-gray-600 mt-2">{senderInfo.date}</div>
      </div>
      ...
      <div className="mt-8">
        <div>Sincerely,</div>
        <div className="mt-4 font-semibold">{senderInfo.fullName}</div>
      </div>
    </div>
  );
};
